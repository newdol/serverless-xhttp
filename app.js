...
// 环境变量
const UUID = process.env.UUID || '38bb479b-7977-4789-a8d6-1806e3803e87'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'ft2nz78guasWRhavTp';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
